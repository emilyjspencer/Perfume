...
<body>
	...
	<table>
		<tr>
			...
			<th>Year Released</th>
			<th>Reviews</th>
			<th>All Stores that sell this perfume</th>
		</tr>
		<c:forEach items="${allPerfumes}" var="perfume">
			<tr>
				<td><form action="/mainCustomer" method="post">
						<input type="button" value="addToBasket">
					</form></td>
				<td>${perfume.name}</td>
				...
				<td><a href="ReviewsPerPerfume/${perfume.perfumeId}">See
						reviews</a></td>
				<td><c:forEach items="${perfume.stores}" var="perfume">
